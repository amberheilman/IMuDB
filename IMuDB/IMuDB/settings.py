# Django settings for IMuDB project.
...
SECRET_KEY = '@#^0&*95y6j#^4*gsr@4)3ffm_yfjv0xawx(rv)ir*pi*(u6(n'
...
ROOT_URLCONF = 'IMuDB.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'IMuDB.wsgi.application'
